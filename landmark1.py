...
# Paths
FRAMES_PATH = "D:\\LipReadingProject\\preprocessing\\frames1"  # Input frames folder
OUTPUT_PATH = "D:\\LipReadingProject\\preprocessing\\landmark1"  # Folder to save processed frames
